...
using ReactApp1.Server.UnitTest;
using Xunit;

namespace ReactApp1.Server.IntegrationTests;
...
public class ExampleIntegrationTest : IClassFixture<IntegrationTestFixture>
{
    ...
    {
        // Arrange — seed required data: an establishment and an employee must exist.
